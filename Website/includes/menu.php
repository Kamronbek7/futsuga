    ...
    <main-->
        ...
        <div class="container">
            <header class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom"> <a href="/"
                    ...
                    <!--svg class="bi me-2" width="40" height="32" aria-hidden="true">
                        <use xlink:href="#futsuga"></use>
                    </svg--> <span class="fs-4">Futsuga</span> </a>
                <ul class="nav nav-pills">
                    <?php
                        define('page', '/pages/');
                        $list_en = ['Home', 'Download', 'Guide', 'FAQ', 'About'];
                        $list_links = ['/', page.'download.php', page.'guide/', '', '#'];
                        // function pages($now='Home') {
                        // global $list_en, $list_links;
                        $n = -1;
                        foreach($list_en as $lst) {
                            $n++;
                            $a = '';
                            // if ($lst == $now) {
                            //     $a = ' active" aria-current="page';
                            // }
                            echo '<li class="nav-item"><a href="' . $list_links[$n] . '" class="nav-link' . $a . '">'. $lst . '</a></li>';
                        }
                        // }
        ...
        <div class="container">
            <header
                ...
                <div class="col-md-3 mb-2 mb-md-0"> <a href="/"
                        class="d-inline-flex link-body-emphasis text-decoration-none"> <svg class="bi" width="40"
                ...
                <div class="col-md-3 text-end"> <button type="button"
                        class="btn btn-outline-primary me-2">Login</button> <button type="button"
                        class="btn btn-primary">Sign-up</button> </div>
            </header>
        </div>
        <!--div class="b-example-divider"></div>
        <navbar class="p-3 text-bg-dark">
            <div class="container">
        ...
        <header class="py-3 mb-3 border-bottom">
            <div class="container-fluid d-grid gap-3 align-items-center" style="grid-template-columns: 1fr 2fr;">
                <div class="dropdown"> <a href="#"
                        ...
                        data-bs-toggle="dropdown" aria-expanded="false" aria-label="Bootstrap menu"> <svg
                ...
                <div class="d-flex align-items-center">
                    <form class="w-100 me-3" role="search"> <input type="search" class="form-control"
        ...
        <header class="py-3 mb-4 border-bottom">
            <div class="container d-flex flex-wrap justify-content-center"> <a href="/"
                    ...
                    <svg class="bi me-2" width="40" height="32" aria-hidden="true">
                        <use xlink:href="#bootstrap"></use>
                    </svg> <span class="fs-4">Double header</span> </a>
                ...
                <div class="container">
                    <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start"> <a
                        ...
                        <ul class="nav col-12 col-lg-auto my-2 justify-content-center my-md-0 text-small">
                            ...
                            <li> <a href="#" class="nav-link text-white"> <svg class="bi d-block mx-auto mb-1"
                                        width="24" height="24" aria-hidden="true">
