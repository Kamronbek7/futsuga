...
class FutsugaAST:
    def __init__(self):
        ...
        self.keyboard_button_handlers = {}
        self.inline_button_handlers = {}
    ...
    def __str__(self):
        return (
            ...
            f"KEYBOARD BUTTON HANDLERS: {self.keyboard_button_handlers}\n\n"
            f"INLINE BUTTON HANDLERS: {self.inline_button_handlers}"
        )
    ...
    def to_dict(self):
        return {
            ...
            "keyboard_button_handlers": self.keyboard_button_handlers,
            "inline_button_handlers": self.inline_button_handlers,
        }
...
print(
    parse_futsuga(open(r"D:\\Files\\1_Projects\\Futsuga\\_excample\\src\\excample.fga", 'rb').read()).keyboard_button_handlers
)
